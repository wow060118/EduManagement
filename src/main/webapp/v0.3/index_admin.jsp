        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="/v0.3/index_admin.jsp" class="nav-link active">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="/v0.3/student_admin.jsp" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="/v0.3/teacher_admin.jsp" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="/v0.3/announcement_admin.jsp" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="/v0.3/class_admin.jsp" class="nav-link">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="/v0.3/department_admin.jsp" class="nav-link">
